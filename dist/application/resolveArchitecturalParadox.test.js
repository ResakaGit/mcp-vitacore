...
describe("resolveArchitecturalParadox", () => {
    it("returns error when paradox_id is empty", async () => {
        ...
        const result = await resolveArchitecturalParadox(ports, "");
    ...
    it("returns error when paradox not found", async () => {
        ...
        const result = await resolveArchitecturalParadox(ports, "missing");
        expect(result.isError).toBe(true);
    ...
    it("returns paradox content and resolves when open with analysis", async () => {
        ...
        const result = await resolveArchitecturalParadox(ports, "p1");
...
//# sourceMappingURL=resolveArchitecturalParadox.test.js.map