...
describe("checkArchitecturalHealth", () => {
    it("returns OK when no paradoxes detected", async () => {
        ...
        const result = await checkArchitecturalHealth(ports);
    ...
    it("inserts paradoxes and returns summary when detected", async () => {
        ...
        expect(ports.storage.insertParadox).toHaveBeenCalledWith(expect.objectContaining({ description: "UTC vs local", analysis: "Conflict" }));
    });
...
//# sourceMappingURL=checkArchitecturalHealth.test.js.map